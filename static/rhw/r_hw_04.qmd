...
To complete the task, you will want to prototype your function (make sure that it works for one run of roll sequence) and then use `map(1:10000, ~ code you want to repeat)` to run the simulation many times (10000 or more). Then find the average of all the simulations to answer the question.
